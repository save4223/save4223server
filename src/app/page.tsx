  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-gray-50 to-white p-8">
      <div className="max-w-2xl text-center">
        <h1 className="mb-4 text-5xl font-bold text-gray-900">Welcome to Save4223 Server</h1>
        <p className="mb-8 text-xl text-gray-600">Next.js + Supabase Fullstack Application</p>
        ...
        {user ? (
          ...
          <div className="space-y-4">
            <div className="rounded-xl bg-yellow-50 p-6">
              <p className="text-yellow-800">⚠️ You are not logged in</p>
            </div>
            <Link
              href="/login"
        ...
        <div className="mt-12 grid gap-6 text-left md:grid-cols-2">
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <p className="text-gray-600">
              Powerful relational database with real-time subscriptions
            </p>
          </div>
          <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
